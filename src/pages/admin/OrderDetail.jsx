	...
	const handleUpdateStatus = async () => {
		try {
			if (orderDetail.status === "Pending")
				await orderService.updateStatus(order_id, "Waiting");
						...
						<div className="status" style={{ flex: 1 }}>
								...
								>
									<span>
										{orderDetail.payment_Method === "Pay On Delivery"
											...
											: orderDetail.payment_Method === "Pay On VnPay"
							...
							<div className="d-flex align-items-center mt-3">
								...
								<div
									style={{
										padding: "10px",
										border: `1px solid ${orderDetail.isPay ? "#009900" : "#FFCC00"}`,
										color: `${orderDetail.isPay ? "#009900" : "#FFCC00"}`,
										borderRadius: "4px",
										fontWeight: "600",
										marginLeft: "31px",
									}}
						...
						<div className="price" style={{ flex: 1 }}>
							...
							<div className="d-flex mb-2">
								...
								<span
									style={{ flex: 2, textAlign: "right" }}
								>{`${new Intl.NumberFormat("vi-VN").format(
									orderDetail.shipping_type.shipCost
								)}₫`}</span>
							</div>
